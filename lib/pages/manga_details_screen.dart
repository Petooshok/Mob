...
class MangaDetailsScreen extends StatelessWidget {
  ...
  final String chapters; // Добавляем поле для глав
                ...
                children: [
                    ...
                    child: Column(
                      children: [
                        ClipRRect(
                          ...
                          child: Image.network(
                            imagePath, // Используем imagePath для обложки
                            width: isMobile ? 120 : 250, // Уменьшен размер для мобильной версии
                            fit: BoxFit.contain,
                          ),
                        ),
                        const SizedBox(height: 50),
                        Text(
                          format, // Используем переданный формат
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            fontFamily: 'Tektur',
                            fontSize: isMobile ? 10.0 : 20.0, // Уменьшен размер для мобильной версии
                            color: const Color(0xFFECDBBA),
                          ),
                        ),
                      ],
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          chapters, // Используем переданные главы
                          style: TextStyle(
                            fontFamily: 'RussoOne',
                        ...
                        Text(
                          description, // Используем переданное описание
                          style: TextStyle(
                            fontFamily: 'RussoOne',
                        ...
                        ElevatedButton(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              fontFamily: 'RussoOne',
                              fontSize: isMobile ? 14.0 : 20.0, // Уменьшен размер для мобильной версии
                              color: const Color(0xFFECDBBA),
                            ),
                            textAlign: TextAlign.center,
                          ),
                          ...
                          children: additionalImages.map((image) {
                            return Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.network(
                                  image,
                                  width: isMobile ? 50 : 80, // Уменьшен размер для мобильной версии
                                  height: isMobile ? 50 : 80, // Уменьшен размер для мобильной версии
                                  fit: BoxFit.contain,
                                ),
                              ),
                            );
              ...
              RichText(
                ...
                text: TextSpan(
                  ...
                  children: [
                    ...
                    TextSpan(
                      text: publisher, // Используем переданное издательство
                      style: TextStyle(
                        fontFamily: 'Tektur',
                        fontSize: isMobile ? 12.0 : 16.0, // Уменьшен размер для мобильной версии
                        color: const Color(0xFFC84B31),
                      ),
                    ),
                    const TextSpan(
